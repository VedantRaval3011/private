                                ...
                                <h3 style={{
                                    ...
                                    {combinedBatchData && (
                                        <span style={{
                                            ...
                                            Γ£ô {batchFiles.filter(f => f.status === 'success').length} file(s) - {combinedBatchData.totalBatches} batches
                                        </span>
                                    )}
                                </h3>
                                <BatchFileUpload
                                ...
                                <h3 style={{
                                    ...
                                    {formulaData && (
                                        <span style={{
                                            ...
                                            Γ£ô Uploaded ({formulaData.masterFormulaDetails.productName})
                                        </span>
                                    )}
                                </h3>
                                <FileUpload
                        ...
                        {(combinedBatchData || formulaData) && !(combinedBatchData && formulaData) && (
                            <div style={{
                                ...
                                <p style={{ color: 'var(--primary-600)', fontWeight: '500' }}>
                                    {combinedBatchData && !formulaData && `Γ£ô ${batchFiles.filter(f => f.status === 'success').length} batch file(s) loaded. Now upload the Formula Master XML.`}
                                    {!combinedBatchData && formulaData && 'Γ£ô Formula data loaded. Now upload the Batch Creation XML(s).'}
                                </p>
                            </div>
                        )}
