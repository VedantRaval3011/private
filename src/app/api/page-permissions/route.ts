...
export const ALL_PAGES = [
  ...
  { pageRoute: '/rm-coa-verification', pageName: 'RM COA Verification' },
  { pageRoute: '/ppm-verification', pageName: 'PPM Verification' },
  { pageRoute: '/pm-verification', pageName: 'PM Verification' },
